package com.lovedata.base._11_哈希表;


import com.lovedata.base._11_哈希表.file.FileInfo;
import com.lovedata.base._11_哈希表.file.Files;
import com.lovedata.base._11_哈希表.map.HashMap;
import com.lovedata.base._11_哈希表.map.LinkedHashMap;
import com.lovedata.base._11_哈希表.map.Map;
import com.lovedata.base._11_哈希表.map.TreeMap;
import com.lovedata.base._11_哈希表.model.Key;
import com.lovedata.base._11_哈希表.model.Person;
import com.lovedata.base._11_哈希表.model.SubKey1;
import com.lovedata.base._11_哈希表.model.SubKey2;
...
public class Main {
	...
	static void tets6(){
		...
		map.put(new Person(1,2f,"jack"),1);
		map.put(new Person(1,2f,"jack"),1);
		map.put(new Person(1,2f,"bob"),1);
		System.out.println(map.get(new Person(1,2f,"jack")));
